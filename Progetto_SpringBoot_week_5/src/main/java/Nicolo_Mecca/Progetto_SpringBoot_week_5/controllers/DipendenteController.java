...
import Nicolo_Mecca.Progetto_SpringBoot_week_5.services.DipendenteService;
...
public class DipendenteController {
    ...
    // 6. PATCH http://localhost:3001/dipendenti/{dipendenteId}/upload-foto
    @PatchMapping("/{dipendenteId}/upload-foto")
